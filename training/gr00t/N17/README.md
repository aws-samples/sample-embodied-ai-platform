# NVIDIA Isaac GR00T N1.7 Training Component

Fine-tune NVIDIA Isaac GR00T N1.7 VLA models using teleoperation/simulation datasets. Supports AWS Batch training with GPU and Amazon DCV for monitoring/evaluation. Use this README as a bridge: high-level usage and structure here; detailed infrastructure/deployment in `infra/README.md`.
...
├── Dockerfile                 # Training container (N1.7, NGC base)
├── build_container.sh         # Build/test/push helper
├── env.example                # Example environment variables
├── finetune_gr00t.py          # GR00T N1.7 training script
├── so101_modality_config.py   # SO-ARM101 modality config for N1.7
