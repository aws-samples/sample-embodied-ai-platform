...
# Build script for GR00T N1.7 Fine-tuning Docker image

set -Eeuo pipefail

echo "=========================================="
echo "Building GR00T N1.7 Fine-tuning Docker Image"
echo "=========================================="
...
if [[ "${USE_STABLE}" == "true" ]]; then
    echo "GR00T version: STABLE (N1.7, tested commit) [default]"
else
